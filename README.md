...
현재 ThanosCleaner는 디시의 삭제 과정 reCAPTCHA 도입으로 슬로우 모드 사용을 권장하고 있습니다. (2019/11/23 기준)

슬로우 모드를 체크하지 않고 사용하시면 reCAPTCHA를 수동으로 해제해주고 다시 클리너를 돌리셔야 하니

**반드시** 슬로우 모드를 체크해주시기 바랍니다.
